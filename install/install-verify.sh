...
#
# The user runs:
#   curl -fsSL https://github.com/lucianople7/kaizen7-jarvis/releases/download/<TAG>/install-verify.sh | bash
#
...
readonly DEFAULT_OFFICIAL_REPO_SLUG="lucianople7/kaizen7-jarvis"
