...
#
# Usage:
#   irm https://github.com/lucianople7/kaizen7-jarvis/releases/download/<TAG>/install-verify.ps1 | iex
#
...
if (-not $EXPECTED_REPO) { $EXPECTED_REPO = 'lucianople7/kaizen7-jarvis' }
