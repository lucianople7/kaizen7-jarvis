...
def test_remote_is_official_accepts_only_exact_repo() -> None:
    ...
    assert u._remote_is_official(
        "https://github.com/lucianople7/kaizen7-personal-jarvis.git"
    )
    assert u._remote_is_official(
        "git@github.com:lucianople7/kaizen7-personal-jarvis.git"
    )
    assert u._remote_is_official("C:\\x\\lucianople7\\kaizen7-personal-jarvis")
    ...
    assert not u._remote_is_official(
        "https://github.com/lucianople7/kaizen7-personal-jarvis-evil.git"
    )
    # ...or one under a different owner with the right repo name.
    assert not u._remote_is_official(
        "https://github.com/evil/kaizen7-personal-jarvis.git"
    )
