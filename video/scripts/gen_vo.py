#!/usr/bin/env python3
"""Generate the onboarding-video voiceover and a deterministic timeline.

Pipeline:
  1. Read the authored script (vo-script.json): a voice, a rate, timing knobs,
...
SCRIPT_PATH = ROOT / "vo-script.json"
VO_DIR = ROOT / "public" / "vo"
OUT_PATH = ROOT / "src" / "intro" / "generated" / "timeline.json"
